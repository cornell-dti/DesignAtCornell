...
const PageNotFound: React.FC = () => (
  <div className={styles.PageNotFound} data-testid="PageNotFound"
    ...
    <div style={{ paddingTop: '2rem' }}>
      <h2 style={{
        width: 'max-content', marginLeft: '2rem', fontSize: '8rem',
        color: 'red', fontWeight: 'bold', letterSpacing: '1rem'
      }}>
        !?
    </h2>
      ...
      <p style={{
        ...
        If you believe that this is an error, contact <a href="mailto:mshepley@cornell.edu">mshepley@cornell.edu</a>.
        <br />
        <br />
        If you believe that this is a technical error, contact <a href="mailto:hello@cornelldti.org">hello@cornelldti.org</a>.
      </p>
    </div>
  </div>
);
