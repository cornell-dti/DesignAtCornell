...
import { FilterDropdownContainer, SearchBar, FilterDropdownScrollContainer, ClearCategoryFilters } from "../ExploreCoursesStyles";
import { FilterDropdownProps } from "../types/PropertyTypes";
import FilterCheckbox from "./FilterCheckbox";
import FilterSelectionBubble from "./FilterSelectionBubble";

const FilterDropdownScroll = ({ checkboxLabels, checkboxData, expand, onCheck, onClear }: FilterDropdownProps) => {
