...
const ArticleBubble = (article: Article) => (
  <ElementContainer style={{width: `270px`, height: `325px`, borderRadius: `20px`}}>
    <VerticalFlex>
      ...
      <Subtitle>
        <p style={{marginTop: `5px`, marginBottom: `-5px`, fontSize: `12px`, lineHeight: `18px`, WebkitLineClamp: 3}}>{article.content_text}</p>
      </Subtitle>
    </VerticalFlex>
  </ElementContainer>
);
