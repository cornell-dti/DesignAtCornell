...
const Title = () => (
  <TitleBackgroundImage style={{backgroundImage: `url(${background})`}}>
    <TitleContainerBox>
        ...
        <p> Grow relationships with like-minded individuals by connecting with the amazing design 
          faculty at Cornell! Expand your knowledge of design through exploring relevant articles.</p>
    </TitleContainerBox>
