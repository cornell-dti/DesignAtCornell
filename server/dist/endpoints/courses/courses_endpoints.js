...
function getCourses(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var courseId, courseCode, localCourses, coursesCollection, _i, coursesCollection_1, doc, docId, cId, cCode, cContent, course, desiredCourse, _a, desiredCourse_1, doc, cContent, course;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    for (_i = 0, coursesCollection_1 = coursesCollection; _i < coursesCollection_1.length; _i++) {
                    ...
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, server_1.courses.doc(currSem).collection(currSem).get()];
                case 3:
                    desiredCourse = (_b.sent()).docs.filter(function (doc) { return doc.id == courseId + " " + courseCode.toString(); });
...
function createCourses(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var course, courseId, courseCode, courseCollection, newCourse;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (courseId === undefined || courseCode === undefined) {
                ...
                server_1.courses.doc(currSem).collection(currSem).doc(courseId + " " + courseCode.toString())["delete"]();
...
function updateCourses(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var field, courseId, courseCode, content;
        return __generator(this, function (_a) {
